...
import designContentRouter from './routes/designContentRoutes.js';
import portfolioContentRouter from './routes/portfolioContentRoutes.js'; // added
...
app.use('/api/portfoliocontent', portfolioContentRouter);
